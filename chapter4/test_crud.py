...
def test_get_players(db_session):
    ...
    players = crud.get_players(db_session, skip = 0, limit = 10_000,
...
def test_get_new_performances(db_session):
    ...
    performances = crud.get_performances(db_session, skip=0, limit=18_000, min_last_changed_date=test_date)
